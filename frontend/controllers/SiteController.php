...
use frontend\models\SignupPelamarForm;
...
class SiteController extends Controller
{
    ...
    {
        $model = new SignupPelamarForm();
        if ($model->load(Yii::$app->request->post())) {
            if ($user = $model->signup()) {
                if (Yii::$app->getUser()->login($user)) {
//                Yii::$app->session->setFlash('userStatus', "Akun anda belum Aktif! Silahkan hubungi administrator");
                return $this->goHome();
                }
            }
        }
